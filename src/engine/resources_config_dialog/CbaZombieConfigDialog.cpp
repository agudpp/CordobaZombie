...
/////////////////////////////////////////////////////////////////////////////////
////
////  XXX  Taken from OgreMain/src/GLX/OgreConfigDialog.cpp
////       from the Object-oriented Graphics Rendering Engine
...
,   mWidget(0)
{
//    mSelectedRenderSystem->shutdown();
//    mSelectedRenderSystem->_initialise(false, "CórdobaZombie 0.1");

    /* TODO: study the use of "mSelectedRenderSystem->_createRenderWindow()"
     *        It may hold the key to the customizations we need.
     *        But first check the lower "todo", in line 520
     */
}
...
CbaZombieConfigDialog::showConfigDialog(Ogre::Root* root)
{
    ...
    /* NOTE: for this to work, a Qt application must have been created *
     * (e.g. with "QApplication app(argc, argv);" in the main app)     */
...
CbaZombieConfigDialog::show(Ogre::Root* root)
{
    ...
    // Attach UI to the widget and show.
