...
// vertices
static inline float heuristic_function(const GEdge *edge, const sm::Point *goal)
{
...
static inline float g_function(const GEdge *edge, const sm::Point *start)
{
	const sm::Vertex *const *Vertexs = edge->getSharedVertex();
...
static inline float nodeCost(TriangleAStar::NodePtr n1, TriangleAStar::NodePtr n2)
{
...
////////////////////////////////////////////////////////////////////////////////
void TriangleAStar::findPath(size_t &size, NodePtr start, NodePtr end,
		const sm::Point &startP, const sm::Point &endP, float radius,
		float &min)
{
	ASSERT(start);
	ASSERT(end);
...
////////////////////////////////////////////////////////////////////////////////
const TriangleAStar::Path TriangleAStar::getshortestPath(const sm::Point &p1,
		const sm::Point &p2, size_t &size, float radius, float &min)
{
