...
public:
	 ...
	 */
	inline void setAABB(const sm::AABB &aabb);
	inline void setRelativeAABB(const sm::AABB &aabb);

	/**
	 * Check if a point is inside of the menu
	 */
	inline bool pointInside(const sm::Point &p) const;
 ...
 * Returns the AABB associated to this menu
 */
inline const sm::AABB &IMenu::getAABB(void) const
{
	return mAABB;
}
 ...
 * Set the AABB to this menu
 */
inline void IMenu::setAABB(const sm::AABB &aabb)
{
	mAABB = aabb;
}
inline void IMenu::setRelativeAABB(const sm::AABB &aabb)
{
 ...
 * Check if a point is inside of the menu
 */
inline bool IMenu::pointInside(const sm::Point &p) const
{
