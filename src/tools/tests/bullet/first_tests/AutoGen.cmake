...
set(HDRS ${HDRS}
	${DEV_ROOT_PATH}/tools/tests/bullet/first_tests/TestingBullet.h
	${DEV_ROOT_PATH}/tools/utils/OrbitCamera.h
)

set(SRCS ${SRCS}
	${DEV_ROOT_PATH}/tools/tests/bullet/first_tests/TestingBullet.cpp
		${DEV_ROOT_PATH}/tools/tests/bullet/first_tests/RagDoll.cpp
	${DEV_ROOT_PATH}/tools/utils/OrbitCamera.cpp
	${DEV_ROOT_PATH}/tools/tests/bullet/first_tests/main.cpp
)
