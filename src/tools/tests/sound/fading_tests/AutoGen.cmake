...
set(HDRS ${HDRS}
	${DEV_ROOT_PATH}/tools/tests/sound/fading_tests/SoundTest.h
	${DEV_ROOT_PATH}/tools/utils/OrbitCamera.h
)

set(SRCS ${SRCS}
	${DEV_ROOT_PATH}/tools/tests/sound/fading_tests/SoundTest.cpp
	${DEV_ROOT_PATH}/tools/tests/sound/fading_tests/main.cpp
