...
protected:
    ...
    /******************************** public methods ******************************/
public:
    MovableText(const String &name, const String &caption, const String &fontName = "StarWars", Real charHeight = 1.0, const ColourValue &color = ColourValue::White);
    virtual ~MovableText();
    ...
    MaterialPtr       &retrieveMaterial(void) {assert(!mpMaterial.isNull());return mpMaterial;};
