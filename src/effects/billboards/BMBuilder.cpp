...
//
inline void
parseUVs(const TiXmlElement &node, effects::UVCoords &result)
{
    // info:
...
//
inline void
parseAtlasInfo(const TiXmlElement &node, effects::AtlasInfo &result)
{
    // info:
...
//
void
parseBatteryInfo(const TiXmlElement &node, effects::BatteryInfo &result)
{
    ASSERT(false);
}
