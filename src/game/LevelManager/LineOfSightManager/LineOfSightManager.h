...
public:
	 ...
	 */
	void buildMatrix(const core::AABB &aabb);
	 ...
	 */
	void setLOS(const core::Vector2 &from, const core::Vector2 &to, bool los);
	 ...
	 */
	inline void getPositionFromCell(int r, int c, core::Vector2 &result) const;
	 ...
	 */
	bool checkLOS(const core::Vector2 &from, const core::Vector2 &to) const;
...
template<int numRows, int numColums>
inline const
core::AABB &LineOfSightManager<numRows, numColums>::getAABB(void) const
{
	return mAABB;
}
