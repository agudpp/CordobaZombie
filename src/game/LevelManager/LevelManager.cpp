...
{
    mCollMngr = new c_p::CollisionManager;
...
////////////////////////////////////////////////////////////////////////////////
void
LevelManager::load(const Ogre::Entity *levelMesh, c_p::cScalar ssX,
    c_p::cScalar ssY, int cnX, int cnY)
{
    ...
    const bool b = Common::Util::getTrianglesFromMesh(mVertexs, mTriangles,
        levelMesh->getMesh());
    ASSERT(b);
    const int r = mPathfindingMngr->loadLevel(mTriangles.getObjs(),
        mVertexs.getObjs());
    ASSERT(r == 0);
...
void
LevelManager::drawTriangle(const Triangle *t)
{
...
////////////////////////////////////////////////////////////////////////////////
void
LevelManager::showTriangles(void)
{
