...
class Shoot : public UpdatableObject
{
    ...
    static const int COLL_FLAG = c_p::SHOOT_AFFECTABLE_MASK;
public:
    /**
     ...
     */
    void
    build(Ogre::Real size);

    /**
     * Set the start position of the shoot
     */
    void
    setStartPos(const Ogre::Vector3 &p);
     ...
     */
    void
    setTranslateVec(const Ogre::Vector3 &t);
    inline const Ogre::Vector3 &
    getTranslateVec(void) const;
...
protected:
    ...
    getCollObj(const core::Vector2 &p1, const core::Vector2 &p2);
