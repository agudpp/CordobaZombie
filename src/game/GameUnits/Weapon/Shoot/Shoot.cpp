...
c_p::CollisionManager *Shoot::mCollMngr = 0;
ShootContainer Shoot::sContainer;
c_p::CollisionResult Shoot::mCollResult;
Hit_t Shoot::mHit;
 ...
 */
const c_p::CollisionObject *
Shoot::getCollObj(const core::Vector2 &p1, const core::Vector2 &p2)
{
    ...
    const c_p::CollisionObject *co = mCollResult.back();
 ...
 */
void
Shoot::setCollisionManager(c_p::CollisionManager *cm)
{
    ASSERT(cm);
    mCollMngr = cm;
}
 ...
 */
void
Shoot::setStartPos(const Ogre::Vector3 &p)
{
    ASSERT(mNode);
    mNode->setPosition(p);
}
 ...
 */
void
Shoot::setTranslateVec(const Ogre::Vector3 &t)
{
    mTranslateVec = t;
