...
Bomb *BombBuilder::createProximityBomb(const TiXmlElement *elem)
{
	ProximityBomb *result = new ProximityBomb;
	return result;
}

Bomb *BombBuilder::createTimeBomb(const TiXmlElement *elem)
{
	TimeBomb *result = new TimeBomb;
	return result;
}

Bomb *BombBuilder::createRemoteBomb(const TiXmlElement *elem)
{
 ...
 */
void BombBuilder::configure(CollisionManager *cm, UpdObjsManager *uom)
{
	ASSERT(cm);
	ASSERT(uom);
 ...
 */
void BombBuilder::setFilename(const Ogre::String &fname)
{
 ...
 */
Bomb *BombBuilder::createBomb(const Ogre::String &ID)
{
	...
	result->setPower(Ogre::StringConverter::parseReal(wxml->Attribute("power")));
	result->setRadius(Ogre::StringConverter::parseReal(wxml->Attribute("range")));
