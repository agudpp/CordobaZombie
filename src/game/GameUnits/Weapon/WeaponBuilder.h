...
public:
     ...
     */
    void
    configureShoots(int n, c_p::CollisionManager *cm, UpdObjsManager *uom);
     ...
     */
    Weapon *
    createWeapon(const Ogre::String &weaponName);
...
private:
     ...
     */
    Weapon *
    buildWeapon(const TiXmlElement *elem);
    Weapon *
    buildShort(const TiXmlElement *elem);
    Weapon *
    buildGrenade(const TiXmlElement *elem);
    Weapon *
    buildLong(const TiXmlElement *elem);
    Weapon *
    buildBody(const TiXmlElement *elem);
