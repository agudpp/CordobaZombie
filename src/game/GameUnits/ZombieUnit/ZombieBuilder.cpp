...
////////////////////////////////////////////////////////////////////////////////
ZombieUnit *
ZombieBuilder::buildZombie(const TiXmlElement *elem)
{
    ASSERT(elem);
    ...
    result->setLife(
        live_t(Ogre::StringConverter::parseInt(elem->Attribute("life"))));
    result->setAttackPower(
        Ogre::StringConverter::parseReal(elem->Attribute("attackPower")));
    result->setWalkVelocity(
        Ogre::StringConverter::parseReal(elem->Attribute("normalVelocity")));
    result->setMaxVelocity(
        Ogre::StringConverter::parseReal(elem->Attribute("attackVelocity")));
    ...
    debugERROR(
        "TODO: FALTA setear los flags de los zombies en los entity para las "
...
////////////////////////////////////////////////////////////////////////////////
ZombieUnit *
ZombieBuilder::buildNormalZombie(const TiXmlElement *elem)
{
    ASSERT(elem);
...
////////////////////////////////////////////////////////////////////////////////
void
ZombieBuilder::setFilename(const Ogre::String &fname)
{
    ...
    billboard::BillboardBatery *bbb, ZombieQueue *q)
{
    ...
    if (cm && !GameObject::collMng)
        GameObject::collMng = cm;
...
////////////////////////////////////////////////////////////////////////////////
ZombieUnit *
ZombieBuilder::createZombie(const Ogre::String &id)
{
    debugOPTIMIZATION(
        "TODO: Para cada uno de los zombies que queremos construir estamos "
