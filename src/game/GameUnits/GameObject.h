...
public:
    ...
    static c_p::CollisionManager *collMng;
...
public:
     ...
     */
    void
    translate(const core::Vector2 &t);
    void
     ...
     */
    void
    advance(const core::Vector2 &m);
    void
    advance(const Ogre::Vector3 &m);

    /**
     * Rotate object over the xz plane (in radians)
     */
    inline void
    rotateObject(Ogre::Real r);
    inline void
    rotateObject(const Ogre::Quaternion &q);
    inline void
     ...
     */
    void
    lookAt(const Ogre::Vector3 &p);
    inline void
    lookAt(const core::Vector2 &p);
    /**
     * Get direction of the object (dir vector or radians of axis y)
     */
    inline const Ogre::Quaternion &
    getOrientation(void) const;
    inline const Ogre::Radian
    getYaw(void) const;
    inline void
    getDirection(core::Vector2 &dir) const;
    inline const core::Vector2 &
     ...
     */
    inline float
    getSqrRadius(void) const;

    /**
     * Perform and Get all the object that collide with this
     */
    const c_p::CollisionResult &
    obtainCollisionObjects(void);
    inline const c_p::CollisionResult &
    getCollideObjects(void) const;
     ...
     */
    void
    getNearbyObjects(float mh, float mw, c_p::mask_t mask,
...
protected:
     ...
     */
    void
    configCollObj(float w, float h, uint32 mF, uint32 mG);

    /**
     * Get the height and the width of the bounding box of the entity.
     */
    void
    getAABBFromEntity(float &w, float &h);
...
////////////////////////////////////////////////////////////////////////////////
inline const core::Vector2 &
GameObject::getPosition(void) const
{
...
////////////////////////////////////////////////////////////////////////////////
void
GameObject::rotateObject(Ogre::Real r)
{
    ASSERT(mNode);
...
////////////////////////////////////////////////////////////////////////////////
void
GameObject::rotateObject(const Ogre::Quaternion &q)
{
    ASSERT(mNode);
    mNode->rotate(q);
    updateActualDirection();
...
void
GameObject::setDirection(const Ogre::Vector3 &d)
{
    ASSERT(mNode);
...
void
GameObject::setDirection(const core::Vector2 &d)
{
    ASSERT(mNode);
...
////////////////////////////////////////////////////////////////////////////////
inline void
GameObject::lookAt(const core::Vector2 &p)
{
...
GameObject::getOrientation(void) const
{
    ASSERT(mNode);
...
////////////////////////////////////////////////////////////////////////////////
inline void
GameObject::getDirection(core::Vector2 &dir) const
{
    dir = mDirection;
}
inline const core::Vector2 &
GameObject::getDirection() const
{
    return mDirection;
}
...
////////////////////////////////////////////////////////////////////////////////
inline float
GameObject::getSqrRadius(void) const
{
    return mSqrRadius;
}
...
////////////////////////////////////////////////////////////////////////////////
inline const c_p::CollisionResult &
GameObject::getCollideObjects(void) const
{
...
////////////////////////////////////////////////////////////////////////////////
inline void
GameObject::updateActualDirection(void)
{
    ASSERT(mNode);
