...
public:
     ...
     */
    int
    getLastHitImpactDir(void) const;
    ...
    inline PathfindingManager::Path &
    getPath(void);
    inline void
    setPath(const PathfindingManager::Path &p);
     ...
     */
    inline bool
    getPathTo(const Ogre::Vector3 &p);
    bool
    getPathTo(const core::Vector2 &p);
    inline bool
    isPathReady(void) const
    {
        return mPathReady;
    }
    ...
    inline UnitPath &
    getUnitPath(void);
    inline const UnitPath &
    getUnitPath(void) const;

    /**
     * Returns the actual pathPoint
     */
    inline const core::Vector2 &
    getActualPathPoint(void) const;
    inline int
    getActualPathIndex(void) const;
    ...
    getActualAnimation(void) const;
    inline int
    getActualAnimID(void) const;

    /* Check if the actual animation has ended */
    inline bool
    hasActualAnimEnd(void) const;

    /* Change the actual animation */
    inline void
    changeAnimation(int animID);

    /**
     * Restart the actual animation to the begin pos
     */
    inline void
    restartActualAnimation(void);
     ...
     */
    inline void
    setAnimationAccelCoef(float coef);
    inline float
    getAnimationAccelCoef(void) const;
    ...
    inline float
    getMaxVelocity(void) const;
    inline void
    setMinVelocity(float v);
    inline float
    getMinVelocity(void) const;
     ...
     */
    inline void
    getFieldOfVision(core::Vector2 &unitDir, core::Vector2 &left,
        core::Vector2 &right) const;
     ...
     */
    inline void
    move(core::Vector2 &move);

    /**
     * Sets/Gets the unit enemy target to attack
     */
    inline GameUnit *
    getActualTarget(void);
    inline const GameUnit *
    getActualTarget(void) const;
    inline void
    setActualTartet(GameUnit *t);

    inline float
    distToActualTarget(void);
     ...
     */
    void
    repellingSteerVec(core::Vector2 &result,
                      const c_p::CollisionResult &objects);
     ...
     */
    void
    seekSteerVec(core::Vector2 &result, const core::Vector2 &target);
     ...
     */
    bool
    followPathSteerVec(core::Vector2 &result);
     ...
     */
    void
    avoidanceSteerVec(core::Vector2 &result, const GameObject *obj);
     ...
     */
    void
    cohesionSteerVec(core::Vector2 &result);
     ...
     */
    void
    alignmentSteerVec(core::Vector2 &result);
     ...
     */
    void
    separationSteerVec(core::Vector2 &result);
     ...
     */
    bool
    haveLineOfSightTo(const GameUnit *other, float maxSqrDist) const;
...
protected:
    ...
    void
    loadAnimations(const std::vector<Ogre::String> &anims);

    /**
     * Configure the unit path of this unit
     */
    void
    configureUnitPath(void);
...
////////////////////////////////////////////////////////////////////////////////
inline const Hit_t &
GameUnit::getLastHit(void) const
{
    return mLastHit;
}
...
////////////////////////////////////////////////////////////////////////////////
inline void
GameUnit::addedToGroup(UnitGroup *g)
{
    ASSERT(mUnitGroup == 0);
    ASSERT(g);
    mUnitGroup = g;
...
////////////////////////////////////////////////////////////////////////////////
inline void
GameUnit::removedFromGroup(UnitGroup *g)
{
    ASSERT(mUnitGroup == g);
    mUnitGroup = 0;
...
////////////////////////////////////////////////////////////////////////////////
inline bool
GameUnit::isCreatorOfGroup(void)
{
    ASSERT(mUnitGroup);
...
////////////////////////////////////////////////////////////////////////////////
inline void
GameUnit::setPath(const PathfindingManager::Path &p)
{
...
////////////////////////////////////////////////////////////////////////////////
inline bool
GameUnit::getPathTo(const Ogre::Vector3 &p)
{
    return getPathTo(core::Vector2(p.x, p.z));
}

////////////////////////////////////////////////////////////////////////////////
inline void
GameUnit::restartPath(void)
{
    mUnitPath.update();
...
////////////////////////////////////////////////////////////////////////////////
inline bool
GameUnit::hasMorePathPoints(void) const
{
...
////////////////////////////////////////////////////////////////////////////////
inline const UnitPath &
GameUnit::getUnitPath(void) const
{
    return mUnitPath;
}
...
////////////////////////////////////////////////////////////////////////////////
inline const core::Vector2 &
GameUnit::getActualPathPoint(void) const
{
    return mUnitPath.getActualPoint();
}

inline int
GameUnit::getActualPathIndex(void) const
{
...
////////////////////////////////////////////////////////////////////////////////
inline Ogre::AnimationState *
GameUnit::getActualAnimation(void) const
{
    return mActualAnim;
}
...
////////////////////////////////////////////////////////////////////////////////
inline int
GameUnit::getActualAnimID(void) const
{
...
////////////////////////////////////////////////////////////////////////////////
inline bool
GameUnit::hasActualAnimEnd(void) const
{
    ASSERT(mActualAnim);
...
////////////////////////////////////////////////////////////////////////////////
inline void
GameUnit::changeAnimation(int animID)
{
    ASSERT(mActualAnim);
...
////////////////////////////////////////////////////////////////////////////////
inline void
GameUnit::restartActualAnimation(void)
{
    mActualAnim->setTimePosition(0.0f);
    if (!mActualAnim->getEnabled()) {
        mActualAnim->setEnabled(true);
    }
}
...
////////////////////////////////////////////////////////////////////////////////
inline void
GameUnit::setAnimationAccelCoef(float coef)
{
    ASSERT(coef > 0);
    mAnimAccelCoef = coef;
}
inline float
GameUnit::getAnimationAccelCoef(void) const
{
...
////////////////////////////////////////////////////////////////////////////////
inline void
GameUnit::setMaxVelocity(float v)
{
    ASSERT(v > 0.0f);
    mMaxVelocity = v;
}
inline float
GameUnit::getMaxVelocity(void) const
{
    return mMaxVelocity;
}
inline void
GameUnit::setMinVelocity(float v)
{
    ASSERT(v > 0.0f);
    mMinVelocity = v;
}
inline float
GameUnit::getMinVelocity(void) const
{
    return mMinVelocity;
}
...
////////////////////////////////////////////////////////////////////////////////
inline void
GameUnit::setVelocity(float v)
{
    ASSERT(v > 0.0f);
    mActualVelocity = v;
}
inline float
GameUnit::getVelocity(void) const
{
...
////////////////////////////////////////////////////////////////////////////////
inline void
GameUnit::getFieldOfVision(core::Vector2 &unitDir, core::Vector2 &left,
    core::Vector2 &right) const
{
...
////////////////////////////////////////////////////////////////////////////////
inline void
GameUnit::move(core::Vector2 &move)
{
...
////////////////////////////////////////////////////////////////////////////////
inline GameUnit *
GameUnit::getActualTarget(void)
{
    return mTarget;
}
inline const GameUnit *
GameUnit::getActualTarget(void) const
{
    return mTarget;
}
...
////////////////////////////////////////////////////////////////////////////////
inline void
GameUnit::setActualTartet(GameUnit *t)
{
    mTarget = t;
}
...
////////////////////////////////////////////////////////////////////////////////
inline float
GameUnit::distToActualTarget(void)
{
...
////////////////////////////////////////////////////////////////////////////////
inline void
GameUnit::configureSoundAPI()
{
    mSAPI.setSceneNode(getSceneNode());
}

////////////////////////////////////////////////////////////////////////////////
inline void
GameUnit::setTimer(float time)
{
    mTimer = time;
}
