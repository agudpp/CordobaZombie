...
public:
	...
	static inline int getIntPointsAABBLine(core::Vector2 p1, core::Vector2 p2, const core::AABB &aabb, 
...
inline int IntersectDetect::getIntPointsAABBLine(core::Vector2 p1, core::Vector2 p2, const core::AABB &aabb, core::Vector2 result[2])
{
